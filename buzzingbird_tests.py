...
"""
    ...
    Tests the BuzzingBird application.
...
class BuzzingBirdTestCase(unittest.TestCase):

    def setUp(self):
        """Before each test, set up a blank database"""
        self.db_fd, buzzingbird.app.config['DATABASE'] = tempfile.mkstemp()
        self.app = buzzingbird.app.test_client()
        buzzingbird.init_db()

    def tearDown(self):
        """Get rid of the database again after each test."""
        os.close(self.db_fd)
        os.unlink(buzzingbird.app.config['DATABASE'])
